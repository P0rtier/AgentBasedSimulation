...
public class Simulation {
    ...
    public int startingAmmountOfAttackers;//helping variable, holding the info of the starting amount of attackers
    ...
    private int stop() {//return 0 - not end, return 1 - end
        if (listOfAttackers.size() <= startingAmmountOfAttackers / 3) {//if the overall number of current team is lower or equal...
            ...
            return 1;
        } else if (listOfDefenders.size() <= startingAmmountOfDefenders / 3) {//--||--
    ...
    private void exportResults() {//standard method for exporting the results
        ...
        System.out.println("\nResults has beeen sent to the exterior file called results.txt, it is located in the Symulacja_Projekt file ");
    }
